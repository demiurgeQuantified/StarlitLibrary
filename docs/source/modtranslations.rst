...
Translations are defined with json files in the ``modTranslations`` directory, in either your common or version directory.
The file name should be the language code that vanilla translations use for that language in full lowercase.
For example, english translations should use ``modTranslations/en.json``.
...
Because of this, it makes the most sense not to have a translation file for your native language.
