...
---@class Action.Predicate<T>
---@overload fun(other: self):self
---
---Evaluator function for the predicate.
---@field evaluate fun(self: self, obj: T):boolean
---
...
---@field predicates table<any, Action.Predicate<InventoryItem>> | nil
---
...
---@class Action.RequiredItem : Action.RequiredItemDef
---@overload fun(def:Action.RequiredItemDef):self
---
---List of predicates the items must pass to be used.
---These are used to implement custom conditions for items.
---@field predicates table<any, Action.Predicate<InventoryItem>>
---
---Number of items required.
---@field count integer
---
...
---@class Action.RequiredObject
---@overload fun(args: Action.RequiredObject):self
---
---Conditions an object must meet.
---@field predicates table<any, Action.Predicate<IsoObject>>
...
---@class ActionDef
---
---ID of the action. Should be unique.
---It is best not to specify an ID for actions that should not be instantiated (e.g. base actions for other actions to derive from).
---@field id string | nil
---
...
---@field requiredItems table<any, Action.RequiredItem> | nil
---
...
---@field requiredObjects table<any, Action.RequiredObject> | nil
---
...
---@field predicates table<any, Action.Predicate<IsoGameCharacter>> | nil
---
...
---@field complete fun(state: ActionState) | nil
---
---Function called when the action begins.
---@field start fun(state: ActionState) | nil
---
---Function called every tick while the action is active.
---@field update fun(state: ActionState) | nil
---
---Function called when the action is stopped before it is successfully completed.
---@field abort fun(state: ActionState) | nil


---Concrete Action.
---@class Action : ActionDef
---@overload fun(def: ActionDef):self
---
---ID of the action. Should be unique.
---@field id string
---
...
---The items picked will be stored under <b>state.items</b> with the same key ('name') as in this table.
---If count is 1, the item will be stored directly: otherwise, it will be a list of items.
---@field requiredItems table<any, Action.RequiredItem>
---
---List of objects required to perform the action.
---The objects picked will be stored under <b>state.objects</b> with the same key ('name') as in this table.
---@field requiredObjects table<any, Action.RequiredObject>
---
---Minimum skills required to perform the action.
---@field requiredSkills table<Perk, integer>
---
---List of predicates that must be met to perform the action.
---@field predicates table<any, Action.Predicate<IsoGameCharacter>>
---
---Animation variables to set at the start of the action. They will be cleared at the end of the action.
---@field animationVariables table<string, boolean | number | string>
---
---Function called upon completion of the action.
---@field complete fun(state: ActionState)
---
---Function called when the action begins.
---@field start fun(state: ActionState)
---
---Function called every tick while the action is active.
---@field update fun(state: ActionState)
---
---Function called when the action is stopped before it is successfully completed.
---@field abort fun(state: ActionState)
...
---@param requiredItem Action.RequiredItem The item requirement.
...
---@param requiredObject Action.RequiredObject The object requirement.
